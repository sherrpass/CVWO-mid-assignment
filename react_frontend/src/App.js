      ...
      <Router>
        <>
          ...
          <Switch>
            ...
            <PrivateRoute exact path="/dashboard" component={TodoDashboard} exact={true}/>
            <PrivateRoute exact path="/create" component={AddTodoPage} />
            <PrivateRoute exact path="/edit/:id" component={EditTodoPage} />
